...
async function main() {
	...
	const tokenAddress = '0x2085CDCb9194029F3a7bAd4602f426F2EFd08Cc8' // 通过createToken产生
	...
	// approve eth allowances 
	

	// // 注意：准备要分配多少币，需要和默克尔根的总和相同
	const _totalAllocation = ethers.utils.parseUnits('0.0341', 8)   //每个人的总和
